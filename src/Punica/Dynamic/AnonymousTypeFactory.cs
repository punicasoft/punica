...
namespace Punica.Dynamic
{
    ...
    /// Source from https://github.com/zzzprojects/System.Linq.Dynamic.Core/blob/master/src/System.Linq.Dynamic.Core/DynamicClassFactory.cs
    /// </summary>
    public static class AnonymousTypeFactory
    {
        ...
        private static readonly string DynamicAssemblyName = "Punica.Anonymous, Version=1.0.0.0";
        private static readonly string DynamicModuleName = "Punica.Anonymous";
        ...
        /// <summary>
        /// Initializes the <see cref="AnonymousTypeFactory"/> class.
        /// </summary>
        ...
        /// </code>
        /// </example>
        public static Type CreateType(IList<AnonymousProperty> properties, bool createParameterCtor = true)
        {
            ...
            if (!GeneratedTypes.TryGetValue(key, out var type))
            {
                ...
                lock (GeneratedTypes)
                {
                    if (!GeneratedTypes.TryGetValue(key, out type))
                    {
                        ...
                        TypeBuilder tb = ModuleBuilder.DefineType(name, TypeAttributes.AnsiClass | TypeAttributes.Public | TypeAttributes.Class | TypeAttributes.AutoLayout | TypeAttributes.BeforeFieldInit);
        ...
        /// <returns></returns>
        private static string GenerateKey(IEnumerable<AnonymousProperty> dynamicProperties, bool createParameterCtor)
        {
